...
namespace ERP.MODEL
{
    public class TeamLeaderHierarchyModel
    {
        ...
        public string SubordinateEmployeeId { get; set; }
        public string SubordinateEmployeeName { get; set; }
        ...
        public List<TeamLeaderHierarchyModel> EmployeeList { get; set; }

        public List<TeamLeaderHierarchyModel> TeamLeaderSubordinateList { get; set; }
