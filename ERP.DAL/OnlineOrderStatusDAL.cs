    ...
    " UPDATE_BY, " +
     ...
     "TRAN_ID " +
      ...
      //      string pOrderReceiveDate, string pOrderDeliveryDate, string pCustomerHomeAddress, string pCellNo, string pOrderSourceId, string pWebAddress, string pDelivered_YN, string pOrderNo, string headOfficeId, string branchOfficeId
        ...
        public List<OnlineOrderSub> SearchTrimsGridDataList(string pOrderReceiveDate, string pOrderDeliveryDate, string pCustomerHomeAddress, string pCustomerName, string pCellNo, string pOrderSourceId, string pWebAddress, bool pDelivered_YN, string pOrderNo, string headOfficeId, string branchOfficeId)
        {
